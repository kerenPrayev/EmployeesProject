from class_Menagers import *
from class_Hayeards import *
...
def check_id_input(employee_id):
    if not employee_id.isdigit():
        ...
        if employee_obje is None:
            ...
            print(f'\nHello {employee_obje.full_name()}')
            print('actions available for you:')
    return employee_obje
...
def get_options_list_by_job(employee_obje):
...
def activating_action_num(employee_obje, action_num):
    ...
    if action_num == 1:
        ...
        attendance_month = Employes.get_month_num()
    ...
    elif action_num == 4 and employee_obje.job == 'm':
                ...
                while True:
                    ...
                    if get_obje(employee_id_to_apdate_atend) in Employes.employees_objects:
                        ...
                        atte_add_row = employee_obje_to_apdate_atend.i_d, employee_obje_to_apdate_atend.full_name()\
                            , date_with_form, start_hour, finish_hour, description
                        ...
                        print(f"atend updated: {date_with_form}, {start_hour} - {finish_hour}")
                        break
                    else:
