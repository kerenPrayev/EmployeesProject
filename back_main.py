...
def activating(employee_obje):
    ...
    if employee_obje.job=='h':
        ...
        if action_num == 1:
            ...
            Employes.make_attandance_xlsx_file(attendancere_rquayeard_list,f'Attendance of {employee_obje.full_name()} in the month: {attendance_month}')
            ...
            if action_num4==1:
                ...
                while True:
                    ...
                    try:
                        ...
                        print(f'the employee {employee_obje_to_remove.full_name()} was removed from the company\'s employeed list')
                        break
                ...
                while True:
                    ...
                    try:
                        ...
                        if employee_obje_to_chang_menager.job=='h':
                            print(f'old menager:{employee_obje_to_chang_menager.manager.full_name()},id:{employee_obje_to_chang_menager.manager.i_d}')
                            ...
                            print(f'{employee_obje_to_chang_menager.full_name()}\'s menager had change from: {old_menager_obje.full_name()}, to: {new_menager_obje.full_name()}')
                            break
                    except AttributeError:
                ...
                if action_num45==1:
                    ...
                    with open('attendance_log.csv','r') as attendance_log:
                        ...
                        for atend in attendance_list:
                            ...
                            if atend_month==attendance_month and get_obje(atend['employee_id']) in employee_obje.hayeard:
                                attendancere_rquayeard_list.append(atend)
                    Employes.make_attandance_xlsx_file(attendancere_rquayeard_list,f'Atendance of all {employee_obje.full_name()}\'s hayeards in the month: {attendance_month}')
                    ...
                    with open('attendance_log.csv', 'r') as attendance_log:
                        ...
                        attendancere_rquayeard_list=[]
                        for atend in attendance_list:
                            if atend['date']==attendance_date and get_obje(atend['employee_id']) in employee_obje.hayeard:
                                attendancere_rquayeard_list.append(atend)
                    Employes.make_attandance_xlsx_file(attendancere_rquayeard_list,f'Atendance of all {employee_obje.full_name()}\'s hayeards in the date: {attendance_date}')
                           ...
                           with open('attendance_log.csv', 'r') as attendance_log:
                               ...
                               for atend in attendance_list:
                                   if atend['employee_id'] == attendance_employee:
                                        attendancere_rquayeard_list.append(atend)
                                   Employes.make_attandance_xlsx_file(attendancere_rquayeard_list,f'Atendance of {get_obje(attendance_employee).full_name()}:')
                    ...
                    with open('attendance_log.csv', 'r') as attendance_log:
                        ...
                        attendancere_rquayeard_list = []
                        for atend in attendance_list:
                            if int(atend['start_hour'][0:2])>9 and attendance_month==int(atend['date'][5:7]) and get_obje(atend['employee_id']) in employee_obje.hayeard:
                                attendancere_rquayeard_list.append(atend)
                    Employes.make_attandance_xlsx_file(attendancere_rquayeard_list,f'Atendance of my late employees in the month: {attendance_month}')
                    ...
                    while True:
                        ...
                        if get_obje(employee_id_to_apdate_atend) in Employes.employees_objects:
                            ...
                            while True:
                                date=input('enter date as the form 2023-01-01:')
                            ...
                            atte_add_row = employee_obje_to_apdate_atend.i_d, employee_obje_to_apdate_atend.full_name(), date, start_hour, finish_hour, description
